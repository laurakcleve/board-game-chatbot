...
if st.button("Submit", key="generationSubmit"):
    ...
    for chunk in index:
        ...
        keyword_score = fuzz.partial_token_set_ratio(question, chunk["keywords"])
        # Gives result of 0 - 1
    ...
    sorted_scores = sorted(vector_scores, key=lambda d: d["score"], reverse=True)
    ...
    Question: <<QUESTION>>
    """
    prompt_prepped = prompt.replace("<<QUESTION>>", question).replace(
    ...
    chat_response = openai.ChatCompletion.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are an expert on the board game 'Nemesis', and your job is to provide answers and information on the rules of the game using excerpts from the rulebook which will be provided for you.",
            },
    ...
    log_data = {"userMessage": prompt_prepped, "assistantMessage": answer}
